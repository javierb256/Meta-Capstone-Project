 ...
 <div className="testimonial-container">
   <Card>
     <div className="testimonial-card">
       ...
       <p>
         The food was very delicious and I will recommend it to all of
         my friends!
       </p>
       <h3>Rating</h3>
   ...
   <Card>
     <div className="testimonial-card">
       ...
       <p>
         I really liked the atmosphere and the waiters were very
         nice.
       </p>
       <h3>Rating</h3>
       <div className="star-container">
   ...
   <Card>
     <div className="testimonial-card">
       ...
       <p>The selection was great and getting seated was very easy!</p>
       <h3>Rating</h3>
       <div className="star-container">
         <img src={Star} alt="star rating" className="star"></img>
         <img src={Star} alt="star rating" className="star"></img>
